...
* 4 二维数组的查找 <<elink25>>                         :2:查找:二维数组:数组:
** 迭代
*** 查右上角 
    - 1
      #+begin_src java :classname 
...
** Question:                                                      :QUESTIONS:
   - [ ] 以上怎么分析复杂度？
* 16 数值的整数次方                   :2:溢出:递归:数值规律:数值计算:TOBEORG:
** 迭代
*** 常规
    #+begin_src java :classname 
      public class Solution {
...
** Question:                                                      :QUESTIONS:
   - [ ] 关于递归的空间复杂度分析？
* 26 树的子结构 <<elink28>>                   :2:递归调用递归:递归:二叉树:树:
** 递归                                                           :RECURSIVE:
   - 1
     #+begin_src java :classname 
       /**
...
** Question:                                                      :QUESTIONS:
   - [ ] 递归的复杂度分析？
   - [ ] 迭代如何实现？
* 27 二叉树的镜像 <<elink22>> :2:BFS:DFS:对称遍历:前序遍历:层序遍历:递归:二叉树:树:
** 递归                                                           :RECURSIVE:
   - 1
     #+begin_src java :classname 
      public class Solution {
...
** 辅助栈
   ...
   - 2
     ...
     #+end_src
* 32 从上往下打印二叉树 <<elink31>>                :2:BFS:层序遍历:二叉树:树:
** 不分层
   - 1
     #+begin_src java :classname 
       import java.util.*;
...
*** Question:                                                     :QUESTIONS:
    - [ ] 非递归中序遍历?
* 37 序列化二叉树 <<elink26>> :2:字符串:层序遍历:前序遍历:递归:二叉树:树:TOBEORG:
** 递归(前序遍历)
   - 1
     #+begin_src java :classname 
       import java.util.*;
...
** 利用数据容器存储
   ...
   - 2
     ...
     #+end_src 
* 41 数据流中的中位数                        :2:小跟堆:大根堆:堆排序:TOBEORG:
  - 1
    #+begin_src java :classname 
      import java.util.*;
...
** Question:                                                      :QUESTIONS:
   - [ ] 为什么用 ~list~ 会慢？
   - [ ] 数学证明有效性？
* 46 把数字翻译成字符串 <<ilink29>> <<elink30>>    :2:DP:递归:字符串:TOBEORG:
** 递归 <<ilink34>>
   - 1
     #+begin_src java :classname 
       class Solution {
...
*** 3次翻转
    ...
    - 2
      ...
      #+end_src 
* 59 队列的最大值 <<elink24>> :2:双端队列:单调队列:队列:滑动窗口:数组:TOBEORG:
** 1 滑动窗口的最大值
*** 蛮力优化
    #+begin_src java :classname 
      class Solution {
...
* 63 股票的最大利润 <<elink27>>                              :2:数组:TOBEORG:
  - 1
    #+begin_src java :classname 
      class Solution {
...
* 65 不用加减乘除做加法                                    :2:位运算:TOBEORG:
  ...
  - 2
    ...
    #+end_src
* 66 构建乘积数组 <<elink23>>                       :2:对称遍历:数组:TOBEORG:
** 对称遍历
   - 1
     #+begin_src java :classname 
       class Solution {
...
* 68 树中两个节点的最低公共祖先           :2:DFS:回溯:递归:二叉树:树:TOBEORG:
** 1 二叉搜索树的最近公共祖先
*** 二叉树性质
**** 迭代
     - 1
